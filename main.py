...
PHOTO = {'Формулы сокращенного умножения': '301', 'Арифметическая прогрессия': '302',
         ...
         'Параллельность прямых': '203', 'Взаимное расположение прямой и плоскости': '204', 'Параллельные плоскости': ('205', '206'),
         ...
         'Связь между площадью фигуры и площадью ее проекции': '218', 'Алгоритм построения сечений': '219', 'Сечение куба': '220',
         'Сечение правильной четырехугольной пирамиды': '221', 'Объемы и площади поверхностей фигур': '222',
         'Механическое движение. Относительность механического движения. Система отсчёта': (401, 403, 402, 396, 397, 398),
         ...
         'Движение по окружности. Угловая и линейная скорость. Центростремительное ускорение': (416, 417, 418, 419, 420, 421),
         ...
         'Сила трения. Сухое трение. Сила трения скольжения, трения покояю. Коэффициент трения': (433, 434, 435, 436, 437),
         ...
         'Работа силы': (458, 461), 'Мощность силы': (459, 460), 'Кинетическая энергия': 462, 'Потенциальная энергия': (463, 464, 465),
         'Закон сохранения механической энергии (ЗСЭ)': 466, 'Гармонические колебания. Амплитуда и фаза колебаний': (467, 468, 469, 470),
         ...
         'Взаимодействие частиц вещества': 479, 'Диффузия. Броуновское движение': 1, 'Модель идеального газа в МКТ': 480,
         ...
         'Уравнение p = nkT': 489, 'Модель идеального газа в термодинамике. Уравнение Менделеева–Клапейрона': (480, 493),
         'Внутренняя энергия идеального одноатомного газа': (511, 512), 'Закон Дальтона для давления смеси разреженных газов': 1,
         ...
         'Испарение и конденсация, кипение жидкости (парообразование)': (504, 505, 503), 'Плавление и кристаллизация': (504, 505, 503),
         ...
         'Удельная теплота парообразования/плавления/сгорания топлива': (507, 508, 503), 'Уравнение теплового баланса': 509,
         'Работа в термодинамике (работа газа)': (514, 515, 516), 'Первый закон термодинамики. Адиабата': (517, 518, 519, 520),
         ...
         'Потенциал электростатического поля. Потенциальная энергия заряда в электростатическом поле': (541, 542, 543, 544, 545),
         ...
         'Последовательное соединение конденсаторов': 598, 'Энергия заряженного конденсатора': (600, 601, 602), 'Сила тока': 549,
         ...
         'Поток вектора магнитной индукции': (563, 564, 565, 566), 'Явление электромагнитной индукции. ЭДС индукции': 567,
         ...
         'Собирающие и рассеивающие линзы. Фокусное расстояние и оптическая сила тонкой линзы': (620, 621, 622, 623, 624, 634),
         'Формула тонкой линзы. Линейное увеличение': (632, 634), 'Построения в линзах': (623, 624, 625, 626, 627, 628, 629, 630),
         ...
         'Дифракция электронов на кристаллах': 1, 'Давление света': (663, 664, 665, 666), 'Планетарная модель атома': 683,
...
def start(message):
    ...
    bot.send_message(message.chat.id,
                     ...
                     "данный момент составлен на основе кодификатора ЕГЭ по физике, дальше будет "
        ...
        case _:
            if message.text in PHOTO.keys():  # Отправка скриншота
                ...
                if arr:
                    ...
                    bot.send_message(message.chat.id, 'Я не понимаю, чего ты хочешь :(', reply_markup=markup)
